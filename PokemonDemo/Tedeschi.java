...
public class Tedeschi extends PokePanel2 {
	private BufferedImage _roomO;
	
	public Tedeschi(GameBoyScreen gbs){
		super(gbs);
	...
	public Tedeschi(GameBoyScreen gbs, int xSpace, int ySpace, int xInd, int yInd, int direction){
	...
	public void addTrainers(){
		...
		*/
				...
				Trainer mart = new Trainer.MartMenu("Tedeschi", this);
				mart.createHome(2, 1);
				this._thisMartContains.clear();
				this._thisMartContains.add(Item.HP_UP);
				this._thisMartContains.add(Item.PROTEIN);
				this._thisMartContains.add(Item.IRON);
				this._thisMartContains.add(Item.CALCIUM);
				this._thisMartContains.add(Item.CARBOS);
	...
	public void createBaseRoom(){
		...
		this.description = "Tedeschi";
		this._roomNum = _gbs.TEDESCHI;
		try{
			if(GameBoyScreen.finishedLoading){
				_gbs.BACKGROUND = ImageIO.read(this.getClass().getResource("/PokemonFiles/Thayer Shops/Tedeschi.png"));
			}
	...
	public void enterRoom(int xInd, int yInd){
		...
		//nice
 		if((xInd == 0)){
 			super.enterRoom(_gbs.THAYER_NORTH, 21, 31, FACEWEST);
 		}
	}
