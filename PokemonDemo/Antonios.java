...
public class Antonios extends PokePanel2 {
	private BufferedImage _roomO;
	
	public Antonios(GameBoyScreen gbs){
		super(gbs);
	...
	public Antonios(GameBoyScreen gbs, int xSpace, int ySpace, int xInd, int yInd, int direction){
	...
	public void addTrainers(){
		...
		*/
				...
				Trainer mart = new Trainer.MartMenu("Antonio's", this);
				mart.createHome(2, 1);
	...
	public void createBaseRoom(){
		...
		this.description = "Antonio's";
		this._roomNum = _gbs.ANTONIOS;
		try{
			if(GameBoyScreen.finishedLoading){
				_gbs.BACKGROUND = ImageIO.read(this.getClass().getResource("/PokemonFiles/Thayer Shops/Antonios and Gorditio Burrito.png"));
			}
	...
	public void enterRoom(int xInd, int yInd){
 		//antonios
 		if((xInd == 4)){
 			super.enterRoom(_gbs.THAYER_NORTH, 14, 18, FACEEAST);
 		}
