...
public class MetroMart extends PokePanel2 {
	private BufferedImage _roomO;
	
	public MetroMart(GameBoyScreen gbs){
		super(gbs);
	...
	public MetroMart(GameBoyScreen gbs, int xSpace, int ySpace, int xInd, int yInd, int direction){
	...
	public void addTrainers(){
		...
		*/
				...
				Trainer mart = new Trainer.MartMenu("Metro Mart", this);
				mart.createHome(2, 1);
				...
				dude.createHome(0, 0);
				dude.getDialogue().add("This place is the best! They even have Vanilla Coke.");
	...
	public void createBaseRoom(){
		...
		this.description = "Metro Mart";
		this._roomNum = _gbs.METRO_MART;
		try{
			if(GameBoyScreen.finishedLoading){
				_gbs.BACKGROUND = ImageIO.read(this.getClass().getResource("/PokemonFiles/Thayer Shops/MetroMart.png"));
			}
	...
	public void enterRoom(int xInd, int yInd){
		//nice
 		if((xInd == 0)){
 			super.enterRoom(_gbs.THAYER_NORTH, 22, 53, FACEWEST);
 		}
